...
after_initialize do
  module ::YoomoneyDonations
    ...
    class NotificationsController < ::ApplicationController
      # Allow YooMoney webhooks to bypass CSRF and XHR checks
      skip_before_action :check_xhr, :verify_authenticity_token, only: [:receive], raise: false
      ...
      def receive
        ...
        if calculated_hash == params[:sha1_hash]
          # withdraw_amount is the amount after Yoomoney комиссия
